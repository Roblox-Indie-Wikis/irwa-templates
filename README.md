...
> [!IMPORTANT]
> Your wiki must be a part of the [Independent Roblox Wiki Alliance](https://indierobloxwikis.org) (IRWA) for it to be added to the bot. Learn more about joining [here](https://indierobloxwikis.org/joining).
...
* Upload **14** wiki logos (see `templates/img` folder)
